...
if (!isset($_POST['login'])) //On est dans la page de formulaire
{
	...
	<p>
	<label for="login" class="id">Identifiants :</label><input class="inid" name="login" type="text" id="login" /><br />
	<label for="password" class="id">Mot de Passe :</label><input class="inid2" type="password" name="password" id="password" />
	</p>
	</fieldset>
...
else
{
    ...
    {
        $query=$db->prepare('SELECT nom, prenom, login, mdp/*,type*/,id, id_cat
